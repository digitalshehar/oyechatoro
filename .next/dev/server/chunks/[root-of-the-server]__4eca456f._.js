...
async function GET(request) {
    try {
        ...
        const items = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].menuItem.findMany({
            where: {
                ...categoryId && {
                    categoryId
                },
...
async function POST(request) {
    try {
        ...
        const item = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].menuItem.create({
            data: {
                name: body.name,
                price: body.price,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4eca456f._.js.map