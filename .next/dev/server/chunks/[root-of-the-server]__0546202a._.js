...
async function GET(request) {
    try {
        ...
        const customers = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].customer.findMany({
            where: search ? {
                OR: [
                    {
                        name: {
...
async function POST(request) {
    try {
        ...
        const customer = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].customer.upsert({
            where: {
                phone: body.phone
            },
            update: {
                ...
                email: body.email,
                totalOrders: {
                    increment: body.orderTotal ? 1 : 0
                },
                totalSpent: {
                    increment: body.orderTotal || 0
                },
                loyaltyPoints: {
                    increment: Math.floor((body.orderTotal || 0) / 100)
                },
                lastVisit: new Date()
            },
            create: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0546202a._.js.map