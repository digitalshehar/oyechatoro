...
function POSPage() {
    ...
    const [orderType, setOrderType] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('Dine In');
    ...
    const [heldOrders, setHeldOrders] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [showHeldOrders, setShowHeldOrders] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [showSplitBill, setShowSplitBill] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [showCustomerSearch, setShowCustomerSearch] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [showQuickKeys, setShowQuickKeys] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [quickKeyItems, setQuickKeyItems] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    // NEW: Enhanced Features State
    const [parcelCharge, setParcelCharge] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [selectedStaff, setSelectedStaff] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [amountTendered, setAmountTendered] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [showLastOrders, setShowLastOrders] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [todaySales, setTodaySales] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        totalOrders: 0,
        totalRevenue: 0,
        cashAmount: 0,
        upiAmount: 0
    });
    const [lastOrders, setLastOrders] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [showRecentModal, setShowRecentModal] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [activeTab, setActiveTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('menu'); // New Mobile Tab State
    ...
    const [kotPrinted, setKotPrinted] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [viewMode, setViewMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('floor'); // Floor View toggle
    const [showOnlineModal, setShowOnlineModal] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false); // Online order modal
    const [onlineCustomer, setOnlineCustomer] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        name: '',
        phone: '',
        address: ''
    });
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "POSPage.useEffect": ()=>{
            const handleKeyDown = {
                "POSPage.useEffect.handleKeyDown": (e)=>{
                    ...
                    if (e.key === 'F5') {
                        e.preventDefault();
                        setShowQuickKeys({
                            "POSPage.useEffect.handleKeyDown": (prev)=>!prev
                    ...
                    if (e.key >= '1' && e.key <= '9' && !(e.target instanceof HTMLInputElement)) {
                        ...
                        if (quickKeyItems[index]) {
                            const item = items.find({
                                "POSPage.useEffect.handleKeyDown.item": (i)=>i.id === quickKeyItems[index]
                            }["POSPage.useEffect.handleKeyDown.item"]);
            ...
            return ({
                "POSPage.useEffect": ()=>window.removeEventListener('keydown', handleKeyDown)
            })["POSPage.useEffect"];
        }
    }["POSPage.useEffect"], [
        cart,
    ...
    const refreshData = ()=>{
        const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDailyStats"])();
        setTodaySales({
        ...
        setLastOrders((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getOrders"])().slice(0, 10)); // Get last 10
    };
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "POSPage.useEffect": ()=>{
    ...
    const getTableStatus = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "POSPage.useCallback[getTableStatus]": (tableNum)=>{
            const activeOrders = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getOrders"])().filter({
                "POSPage.useCallback[getTableStatus].activeOrders": (o)=>o.type === 'Dine-in' && o.table === tableNum && o.status !== 'Completed' && o.status !== 'Cancelled'
            }["POSPage.useCallback[getTableStatus].activeOrders"]);
    ...
    }["POSPage.useCallback[getTableStatus]"], []);
    // Handle table click
    ...
    const activeItems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "POSPage.useMemo[activeItems]": ()=>{
            return items.filter({
                "POSPage.useMemo[activeItems]": (item)=>item.status === 'Active'
            }["POSPage.useMemo[activeItems]"]);
        }
    }["POSPage.useMemo[activeItems]"], [
        items
    ...
    const filteredItems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "POSPage.useMemo[filteredItems]": ()=>{
            let result = activeItems;
            if (activeCategory !== 'all') {
                result = result.filter({
                    "POSPage.useMemo[filteredItems]": (item)=>item.categoryId === activeCategory
                }["POSPage.useMemo[filteredItems]"]);
            }
            if (searchQuery) {
                const lowerQuery = searchQuery.toLowerCase();
                result = result.filter({
                    "POSPage.useMemo[filteredItems]": (item)=>item.name.toLowerCase().includes(lowerQuery) || item.description.toLowerCase().includes(lowerQuery)
                }["POSPage.useMemo[filteredItems]"]);
            }
            return result;
        }
    ...
    const addToCart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "POSPage.useCallback[addToCart]": (item)=>{
            setCart({
                "POSPage.useCallback[addToCart]": (prev)=>{
                    const existing = prev.find({
                        "POSPage.useCallback[addToCart].existing": (i)=>i.id === item.id
                    }["POSPage.useCallback[addToCart].existing"]);
                    if (existing) {
                        return prev.map({
                            "POSPage.useCallback[addToCart]": (i)=>i.id === item.id ? {
                                    ...i,
    ...
    const handleCheckout = ()=>{
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createOrder"])(orderData);
        printReceipt();
        setShowSuccess(true);
        setTimeout(()=>{
...
_s(POSPage, "k9mowI8dO4/GQR9drvT289iveao=", false, function() {
    return [
