...
export default function WhatsAppSettingsPage() {
    ...
    return (
        <div className="p-4 md:p-8 max-w-4xl mx-auto">
            ...
            {/* Status Card */}
            <div className={`p-6 rounded-2xl mb-8 ${isConfigured ? 'bg-green-50 border-2 border-green-200' : 'bg-yellow-50 border-2 border-yellow-200'}`}>
                <div className="flex items-center gap-4">
                    <div className={`text-4xl ${isConfigured ? '' : 'opacity-50'}`}>
                        {isConfigured ? '✅' : '⚠️'}
                    </div>
                    <div>
                        <div className={`text-xl font-bold ${isConfigured ? 'text-green-700' : 'text-yellow-700'}`}>
                            {isConfigured ? 'Connected & Active' : 'Not Configured'}
                        </div>
                        <div className={`text-sm ${isConfigured ? 'text-green-600' : 'text-yellow-600'}`}>
                            {isConfigured
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg mb-8">
                ...
                <div className="space-y-4">
                    <div className="flex items-start gap-4 p-4 bg-blue-50 rounded-xl">
                        ...
                        <div>
                            <div className="font-bold text-blue-800">Order Status → "Ready"</div>
                    ...
                    <div className="flex items-start gap-4 p-4 bg-green-50 rounded-xl">
                        ...
                        <div>
                            <div className="font-bold text-green-800">Order Status → "Completed"</div>
            ...
            {!isConfigured && (
                <div className="bg-white p-6 rounded-2xl shadow-lg mb-8">
                    ...
                    <div className="mt-4 bg-gray-900 text-green-400 p-4 rounded-xl font-mono text-sm overflow-x-auto">
                        <div>WHATSAPP_PHONE_ID=your_phone_number_id</div>
                        <div>WHATSAPP_ACCESS_TOKEN=your_access_token</div>
                    </div>

                    <div className="mt-4 p-4 bg-orange-50 rounded-xl">
                        <div className="font-bold text-orange-700">💡 Note</div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg">
                ...
                {testResult && (
                    <div className={`mt-4 p-4 rounded-xl ${testStatus === 'success' ? 'bg-green-50 text-green-700' : 'bg-red-50 text-red-700'
                        }`}>
                        {testResult}
                    </div>
                )}
            ...
            <div className="mt-8 p-6 bg-gradient-to-r from-green-500 to-emerald-600 rounded-2xl text-white">
                ...
                <div className="grid md:grid-cols-2 gap-3">
                    ...
                    <div className="flex items-center gap-2">
                        <span>✓</span> Graceful Fallback (No errors if not configured)
                    </div>
                    <div className="flex items-center gap-2">
